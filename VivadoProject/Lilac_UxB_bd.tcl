...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.PSU_MIO_TREE_PERIPHERALS {Quad SPI Flash#Quad SPI Flash###Quad SPI Flash#Quad SPI Flash#############################UART 0#UART 0#UART 1#UART 1########################################} \
   CONFIG.PSU_MIO_TREE_SIGNALS {sclk_out#miso_mo1###mosi_mi0#n_ss_out#############################rxd#txd#txd#rxd########################################} \
