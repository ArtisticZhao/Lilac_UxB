...
proc create_root_design { parentCell } {
  ...
  create_hier_cell_config_const [current_bd_instance .] config_const
  ...
  set_property -dict [ list \
   ...
   CONFIG.PSU_MIO_TREE_PERIPHERALS {Quad SPI Flash#Quad SPI Flash###Quad SPI Flash#Quad SPI Flash#####################CAN 0#CAN 0#CAN 1#CAN 1#####UART 0#UART 0##########################################} \
   CONFIG.PSU_MIO_TREE_SIGNALS {sclk_out#miso_mo1###mosi_mi0#n_ss_out#####################phy_rx#phy_tx#phy_tx#phy_rx#####rxd#txd##########################################} \
  ...
  connect_bd_intf_net -intf_net diff_clock_rtl_0_1 [get_bd_intf_ports gt_refclk] [get_bd_intf_pins gig_ethernet_pcs_pma_0/gtrefclk_in]
  connect_bd_intf_net -intf_net gig_ethernet_pcs_pma_0_sgmii [get_bd_intf_ports sfp0] [get_bd_intf_pins gig_ethernet_pcs_pma_0/sgmii]
  ...
  connect_bd_net -net zynq_ultra_ps_e_0_emio_gpio_o [get_bd_pins rst_slice/Din] [get_bd_pins zynq_ultra_ps_e_0/emio_gpio_o]
